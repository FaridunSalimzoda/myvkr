    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cours.topictable', verbose_name='Тема')),
            ],
            options={
                'verbose_name': 'Тест',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cours.coursetable', verbose_name='Курс')),
                ('quiz', models.ManyToManyField(blank=True, null=True, to='quiz.Quiz', verbose_name='Quiz')),
            ],
            options={
                'verbose_name': 'Вопрос',
